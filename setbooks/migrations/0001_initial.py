# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-11-29 06:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_delete', models.BooleanField(default=False)),
                ('hbook', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='heros', to='setbooks.BookInfo')),
            ],
            options={
                'db_table': 'tb_heros',
                'verbose_name': '英雄',
